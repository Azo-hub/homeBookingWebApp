...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(SecurityConstant.AZEEZ_RIDWAN)
                .withAudience(SecurityConstant.AZEEZ_RIDWAN_ADMIN)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm)
                    .withIssuer(SecurityConstant.AZEEZ_RIDWAN).build();
